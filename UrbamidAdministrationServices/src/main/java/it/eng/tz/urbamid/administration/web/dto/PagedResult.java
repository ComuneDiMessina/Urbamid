package it.eng.tz.urbamid.administration.web.dto;
...
public class PagedResult<ENTITY> implements Serializable {
	...
	public PagedResult(PagedListHolder<ENTITY> page) {
		super();
		this.totalPages = page.getPageCount();
		this.totalElements = page.getNrOfElements();
		this.number = page.getPage();
		this.size = page.getPageSize();
		this.numberOfElements = page.getNrOfElements();
		this.content = page.getPageList();
		this.first = page.isFirstPage();
		this.last = page.isLastPage();
	}
