 ...
 *
 */
public class GSFeatureTypes {

	private List<GSFeatureTypeShort> featureType;

	public GSFeatureTypes() {
		super();
	}

	public List<GSFeatureTypeShort> getFeatureType() {
		return featureType;
	}

	public void setFeatureType(List<GSFeatureTypeShort> featureType) {
