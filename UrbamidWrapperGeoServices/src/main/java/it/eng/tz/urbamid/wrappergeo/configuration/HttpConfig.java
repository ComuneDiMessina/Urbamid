...
//		int timeout = new Integer(env.getProperty("rubrica.http.client.timeout"));
		int timeout = Integer.parseInt(env.getProperty("wrappergeo.http.client.timeout"));
		
		CloseableHttpClient httpClient = null;
		String keystores = env.getProperty("wrappergeo.certificate");
		...
		boolean proxyEnable = Boolean.valueOf(env.getProperty("wrappergeo.http.client.proxyEnable"));
		if (proxyEnable)
		{
			Integer proxyPort = Integer.valueOf(env.getProperty("wrappergeo.http.client.portProxy"));
			String proxyHost = env.getProperty("wrappergeo.http.client.hostProxy");
			BasicCredentialsProvider credentialProvider = new BasicCredentialsProvider();
			AuthScope scope = new AuthScope(proxyHost, proxyPort.intValue());
			String usernameProxy = env.getProperty("wrappergeo.http.client.usernameProxy");
			String passwordProxy = env.getProperty("wrappergeo.http.client.passwordProxy");
			...
			ProxyRoutePlanner proxyRoutPlanner = new ProxyRoutePlanner(new HttpHost(proxyHost, proxyPort.intValue()), env.getProperty("wrappergeo.http.client.urlNotProxy"));
