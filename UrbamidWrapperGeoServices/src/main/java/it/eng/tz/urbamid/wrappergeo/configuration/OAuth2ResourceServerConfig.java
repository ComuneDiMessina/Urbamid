...
public class OAuth2ResourceServerConfig extends ResourceServerConfigurerAdapter {
	...
	public void configure(final ResourceServerSecurityConfigurer config) {
		...
		.resourceId(env.getProperty("wrappergeo.oauth.resource.id"));
	}
	...
	{
		return new JwkTokenStore(env.getProperty("wrappergeo.oauth.jwt.key.url"), accessTokenConverter());
	}
	...
	public JwtClaimsSetVerifier issuerClaimVerifier() {
		try {
			return new IssuerClaimVerifier(new URL(env.getProperty("wrappergeo.oauth.jks.claim.issuer.url")));
