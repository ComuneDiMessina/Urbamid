...
public abstract class AbstractConverter<MODEL, DTO> {
	 ...
	 */
	public List<DTO> toDTO( Iterable<MODEL> models ) throws ConverterException {
	 ...
	 * @param pageModels è la pagina di MODEL
	 ...
	 * @throws ConverterException 
	 */
	public Optional<DTO> toDTO( Optional<MODEL> optional ) throws ConverterException{
	 ...
	 * @throws ConverterException 
	 */
	public Optional<MODEL> toModel( Optional<DTO> optional ) throws ConverterException{
		return ( optional.isPresent() ) ? 
