...
@Configuration
@EnableCaching
public class CatastoDbCacheConfig extends CachingConfigurerSupport {
	@Autowired
	...
	private CacheManager createCacheManager() {
		long dimensioneCache = Long.parseLong(env.getProperty("catasto.db.cache.cache.size"));
		long ttlMillisecondi = Long.parseLong(env.getProperty("catasto.db.cache.cache.ttl"));
	...
	private Map<String, org.ehcache.config.CacheConfiguration<?, ?>> createCacheConfigurations(
		...
		for (BeanDefinition bd : scanner
				.findCandidateComponents("it.eng.tz.urbamid.catasto.persistence.model")) {
