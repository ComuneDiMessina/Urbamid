...
@Entity
@Table(name="u_cat_planimetrie")
public class Planimetria implements Serializable {
	...
	@Column(name = "cat_catastale", length=6)
	private String catCatastale;

	@Column(name = "superficie", length=3)
	private String superficie;

	@Column(name = "foglio", length=1)
	private String foglio;

	@Column(name = "mappale", length=6)
	private String mappale;

	@Column(name = "subalterno", length=3)
	private String subalterno;

	@Column(name = "dug", length=7)
	private String dug;
	...
	public String getCatCatastale() {
		return catCatastale;
	}

	public void setCatCatastale(String catCatastale) {
