...
@Entity
@Table(name="u_cat_particelle_storico", schema="storico")
public class StoricoParticella implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof StoricoParticella)) {
			return false;
		}
		StoricoParticella other = (StoricoParticella) obj;
