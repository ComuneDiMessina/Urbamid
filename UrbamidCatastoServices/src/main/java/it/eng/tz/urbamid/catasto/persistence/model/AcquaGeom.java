...
@Entity
@Table(name="u_cat_acque")
//@AttributeOverrides({ @AttributeOverride(name = "id", column = @Column(name = "gid")) })
public class AcquaGeom implements Serializable {

	private static final long serialVersionUID = -8996071414078399800L;

	@Id 
	@SequenceGenerator(name="u_cat_acque_gid_seq", sequenceName="u_cat_acque_gid_seq", allocationSize=1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator="u_cat_acque_gid_seq")
