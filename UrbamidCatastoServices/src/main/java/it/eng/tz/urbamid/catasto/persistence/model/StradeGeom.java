...
@Entity
@Table(name="u_cat_strade")
public class StradeGeom implements Serializable {

	private static final long serialVersionUID = -6539165875279459773L;

	@Id 
	@SequenceGenerator(name="u_cat_strade_gid_seq", sequenceName="u_cat_strade_gid_seq", allocationSize=1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator="u_cat_strade_gid_seq")
