...
//		int timeout = new Integer(env.getProperty("rubrica.http.client.timeout"));
		int timeout = Integer.parseInt(env.getProperty("catasto.http.client.timeout"));
		
		CloseableHttpClient httpClient = null;
		String keystores = env.getProperty("catasto.certificate");
		...
		boolean proxyEnable = Boolean.valueOf(env.getProperty("catasto.http.client.proxyEnable"));
		if (proxyEnable)
		{
			Integer proxyPort = Integer.valueOf(env.getProperty("catasto.http.client.portProxy"));
			String proxyHost = env.getProperty("catasto.http.client.hostProxy");
			BasicCredentialsProvider credentialProvider = new BasicCredentialsProvider();
			AuthScope scope = new AuthScope(proxyHost, proxyPort.intValue());
			String usernameProxy = env.getProperty("catasto.http.client.usernameProxy");
			String passwordProxy = env.getProperty("catasto.http.client.passwordProxy");
			...
			ProxyRoutePlanner proxyRoutPlanner = new ProxyRoutePlanner(new HttpHost(proxyHost, proxyPort.intValue()), env.getProperty("catasto.http.client.urlNotProxy"));
