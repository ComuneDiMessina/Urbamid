...
@Entity
@Table(name="u_cat_riserve_particella")
public class RiservaParticella implements Serializable {

	private static final long serialVersionUID = -5748671745991501474L;

	@Id 
	@SequenceGenerator(name="riserva_particella_id_seq", sequenceName="riserva_particella_id_seq", allocationSize=1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator="riserva_particella_id_seq")
