...
public class VisuraFabbricatoStoricaInput {
	...
	private String sub;
	private JRBeanCollectionDataSource immobiliDataSet;
	...
	public Map<String, Object> getDataSources() {
	       ...
	       dataSources.put("immobiliDataSet", immobiliDataSet);
	...
	public JRBeanCollectionDataSource getImmobiliDataSet() {
		return immobiliDataSet;
	}

	public void setImmobiliDataSet(JRBeanCollectionDataSource immobiliDataSet) {
		this.immobiliDataSet = immobiliDataSet;
	}
