...
public class OAuth2ResourceServerConfig extends ResourceServerConfigurerAdapter {
	...
	public void configure(final ResourceServerSecurityConfigurer config) {
		...
		.resourceId(env.getProperty("toponomastica.oauth.resource.id"));
	}
	...
	{
		return new JwkTokenStore(env.getProperty("toponomastica.oauth.jwt.key.url"), accessTokenConverter());
	}
	...
	public JwtClaimsSetVerifier issuerClaimVerifier() {
		try {
			return new IssuerClaimVerifier(new URL(env.getProperty("toponomastica.oauth.jks.claim.issuer.url")));
