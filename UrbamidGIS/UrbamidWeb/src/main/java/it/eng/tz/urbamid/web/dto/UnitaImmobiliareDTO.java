...
public class UnitaImmobiliareDTO implements Serializable {
	...
	private String renditaLireStr;
	private Double renditaEuro;
	private String renditaEuroStr;
	...
	public String getRenditaLireStr() {
		return renditaLireStr;
	}
	public void setRenditaLireStr(String renditaLireStr) {
		this.renditaLireStr = renditaLireStr;
	}
	public String getRenditaEuroStr() {
		return renditaEuroStr;
	}
	public void setRenditaEuroStr(String renditaEuroStr) {
		this.renditaEuroStr = renditaEuroStr;
	}
