...
(function($) {
    ...
    $.sessionTimeout = function(options) {
        ...
        var lastPingKeepAlive = new XDate();
        ...
        if (!opt.ignoreUserActivity) {
            ...
            $(document).on('keyup mouseup click mousemove touchend touchmove', function(e) {
            	if(lastPingKeepAlive == null || lastPingKeepAlive <= new Date()){
            		if (e.type === 'mousemove') {
	                ...
	                lastPingKeepAlive = new XDate();
            		lastPingKeepAlive.addSeconds(1200);
            		lastPingKeepAlive = lastPingKeepAlive.toDate();
            	 }
	        });
