...
<body lang="it">
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/js/catasto/PaginaImportaDatiCtrl.js"></script>
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/js/catasto/RicercheRest.js"></script>
</body>
</html>