...
<%-- 	<script type="text/javascript" src="<%=request.getContextPath()%>/js/include/mappa.js"></script> --%>
	...
	<link type="text/css" href="<%=request.getContextPath()%>/css/catasto.css" rel="Stylesheet">
...
<body lang="it">
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/plugin/jsTreeGrid/jstreegrid.js"></script>
	...
	<jsp:include page="/template/pianoRegolatore/pianoRegolatore-handlebars.jsp"></jsp:include>
	<jsp:include page="/template/common/estrazioni-handlebars.jsp"></jsp:include>
	<!-- CUSTOM PAGE CONTROLLER -->
	<script type="text/javascript" src="<%=request.getContextPath()%>/js/include/BaseModaleCtrl.js"></script>
	<script type="text/javascript" src="<%=request.getContextPath()%>/js/pianoRegolatore/BaseJsTreeModaleRicercaCtrl.js"></script>
	<script type="text/javascript" src="<%=request.getContextPath()%>/js/pianoRegolatore/PianoRegolatoreCtrl.js"></script>
	<script type="text/javascript" src="<%=request.getContextPath()%>/js/pianoRegolatore/StrumentiAmbitoVarianteCtrl.js"></script>
	<script type="text/javascript" src="<%=request.getContextPath()%>/js/pianoRegolatore/StrumentiCertificatoUrbanisticoCtrl.js"></script>
	<script type="text/javascript" src="<%=request.getContextPath()%>/js/pianoRegolatore/PianoRegolatoreRest.js"></script>
	<script type="text/javascript" src="<%=request.getContextPath()%>/js/catasto/CatastoRest.js"></script>
