			...
			<div class="row nom nopt mainCont">
				<div class="container-fluid" style="padding: 5% 0px 5% 0px;">
					<div style="width: 95%;background-color: white;border: 2px solid #004275;margin-left: 2%;
						...
						<h2 class="text-align:center" style="margin: 0px 1%;width: 100%;color: #004275;font-size: 35px;">Accesso Negato</h2>
						<h3 style="margin: 5px 1%;width: 100%;color: #004275;font-size: 20px;">
							Per autenticarsi <a href="https://urbamidplus.comune.messina.it/UrbamidWeb">cliccare qui</a>
						</h3>
					</div>
				</div>
			</div>
