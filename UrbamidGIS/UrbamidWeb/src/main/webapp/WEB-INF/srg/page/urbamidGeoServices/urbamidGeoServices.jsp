...
<body lang="it">
	...
	<div class="generalContainer">
		...
		<!-- USER-MAP -->
		<jsp:include page="/template/header/header-urbaGeoServices.jsp"></jsp:include>
		
		<!-- DETTAGLIO MAPPA -->
		<div id="containerTableMappe" style="background-color:#fff">
			<jsp:include page="/template/urbamidGeoServices/urbamidGeoServices.jsp"></jsp:include>
		</div>
	</div>
