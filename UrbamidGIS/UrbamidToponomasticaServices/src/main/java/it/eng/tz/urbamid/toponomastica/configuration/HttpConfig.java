...
//		int timeout = new Integer(env.getProperty("rubrica.http.client.timeout"));
		int timeout = Integer.parseInt(env.getProperty("toponomastica.http.client.timeout"));
		
		CloseableHttpClient httpClient = null;
		String keystores = env.getProperty("toponomastica.certificate");
		...
		boolean proxyEnable = Boolean.valueOf(env.getProperty("toponomastica.http.client.proxyEnable"));
		if (proxyEnable)
		{
			Integer proxyPort = Integer.valueOf(env.getProperty("toponomastica.http.client.portProxy"));
			String proxyHost = env.getProperty("toponomastica.http.client.hostProxy");
			BasicCredentialsProvider credentialProvider = new BasicCredentialsProvider();
			AuthScope scope = new AuthScope(proxyHost, proxyPort.intValue());
			String usernameProxy = env.getProperty("toponomastica.http.client.usernameProxy");
			String passwordProxy = env.getProperty("toponomastica.http.client.passwordProxy");
			...
			ProxyRoutePlanner proxyRoutPlanner = new ProxyRoutePlanner(new HttpHost(proxyHost, proxyPort.intValue()), env.getProperty("toponomastica.http.client.urlNotProxy"));
