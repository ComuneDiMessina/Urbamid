...
import it.eng.tz.urbamid.wrappergeo.persistence.repositories.ParametroShapeToDbRepository;
 ...
 */
@Service
public class WrapperPathServiceImpl implements WrapperPathService {
	 ...
	 */
	private final ParametroShapeToDbRepository repositoryParametri;
	 ...
	 */
	public WrapperPathServiceImpl(ParametroShapeToDbRepository repositoryParametri) {
		Assert.notNull(repositoryParametri, "ParametroShapeToDbRepository must not be null but don't panic!");
	...
	@Override
	public String rootPath() throws WrapperGeoServiceException {
	...
	public String jobDataDirectory() throws WrapperGeoServiceException {
		File file = Paths.get(
				this.rootPath())
					.toFile();
	...
	public String jobDataShapeDirectory(String nameShape) throws WrapperGeoServiceException {
		File file = Paths.get(
				this.rootPath(),
				nameShape)
					.toFile();
	...
	@Override
	public String sqlScriptDirectory(String nameShape) throws WrapperGeoServiceException {
	...
	@Override
	public String jobDataStyleDirectory() throws WrapperGeoServiceException {
		File file = Paths.get(
				this.rootPath(),
				StorageFolder.STYLE.name())
					.toFile();
		Assert.isTrue(file.exists(), "Job data directory MUST exists!");
		return file.getAbsolutePath();
	}
