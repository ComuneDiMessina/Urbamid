...
namespace UrbamidAddIn
{
    public class ConvertLayerToSld
    {
        ...
        internal StructProject getStrutturaPoint(IGeoFeatureLayer geoFeatureLayer, IFeatureLayer featureLayer)
        {
            try
            {
                ISimpleRenderer unique = (ISimpleRenderer)geoFeatureLayer.Renderer;
                strutturaLayer.LayerList = new ArrayList();
                strutturaLayer.LayerList.Add((object)StoreStructPointRenderer((ISimpleRenderer)geoFeatureLayer.Renderer, featureLayer));
                addOneToLayerNumber();
        ...
        private StructSimpleRenderer StoreStructPointRenderer(ISimpleRenderer Renderer, IFeatureLayer Layer)
        {
            ...
            try
            {
                ...
                structSimpleRenderer1.Annotation = getAnnotation(Layer);
        ...
        internal StructProject getStrutturaLayer(IGeoFeatureLayer geoFeatureLayer, IFeatureLayer featureLayer)
        {
        ...
        private StructUniqueValueRenderer StoreStructUVRenderer(IUniqueValueRenderer Renderer, IFeatureLayer Layer)
        {
            ...
            try
            {
                ...
                uniqueValueRenderer1.Annotation = getAnnotation(Layer);
                int fieldCount = Renderer.FieldCount;
                ...
                //{
                    ...
                    //if (iannotateLayerProperties is ILabelEngineLayerProperties & iannotateLayerProperties.DisplayAnnotation){
                        ...
                        double ddd = engineLayerProperties.BasicOverposterLayerProperties.LineOffset;
                            ...
                            structAnnotation.PropertyName = expr.Replace("[", "").Replace("]", ""); // engineLayerProperties.Expression.Replace("[", "").Replace("]", "");
        ...
        private bool writeLineFeatures(object Symbol)
        {
            ...
            try
            {
                ...
                {
                    object obj = Symbol;
                    StructMultilayerLineSymbol multilayerLineSymbol = new UrbamidAddIn.ConvertLayerToSld.StructMultilayerLineSymbol();
                ...
                if (!strut.Equals(default(StructMultilayerLineSymbol)))
                {
                    for (int i = num3; i >= 0; i--)
                    {
                        ...
                        {
                            StructMultilayerMarkerSymbol maker = ((UrbamidAddIn.ConvertLayerToSld.StructMarkerLineSymbol)(strut.MultiLineLayers[i])).MarkerSymbol_MultilayerMarker;
        ...
        internal StructClassBreaksRenderer getStructBreacks(IClassBreaksRenderer renderer, IFeatureLayer layer)
        {
            ...
            try
            {
                ...
                classBreaksRenderer1.Annotation = getAnnotation(layer); // this.GetAnnotation(Layer);
