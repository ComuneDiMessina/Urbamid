...
//		int timeout = new Integer(env.getProperty("administration.http.client.timeout"));
		int timeout = Integer.parseInt(env.getProperty("administration.http.client.timeout"));
		
		CloseableHttpClient httpClient = null;
		String keystores = env.getProperty("administration.certificate");
		...
		boolean proxyEnable = Boolean.valueOf(env.getProperty("administration.http.client.proxyEnable"));
		if (proxyEnable)
		{
			Integer proxyPort = Integer.valueOf(env.getProperty("administration.http.client.portProxy"));
			String proxyHost = env.getProperty("administration.http.client.hostProxy");
			BasicCredentialsProvider credentialProvider = new BasicCredentialsProvider();
			AuthScope scope = new AuthScope(proxyHost, proxyPort.intValue());
			String usernameProxy = env.getProperty("administration.http.client.usernameProxy");
			String passwordProxy = env.getProperty("administration.http.client.passwordProxy");
			...
			ProxyRoutePlanner proxyRoutPlanner = new ProxyRoutePlanner(new HttpHost(proxyHost, proxyPort.intValue()), env.getProperty("administration.http.client.urlNotProxy"));
