...
public class OAuth2ResourceServerConfig extends ResourceServerConfigurerAdapter {
	...
	public void configure(final ResourceServerSecurityConfigurer config) {
		...
		.resourceId(env.getProperty("administration.oauth.resource.id"));
	}
	...
	{
		return new JwkTokenStore(env.getProperty("administration.oauth.jwt.key.url"), accessTokenConverter());
	}
	...
	public JwtClaimsSetVerifier issuerClaimVerifier() {
		try {
			return new IssuerClaimVerifier(new URL(env.getProperty("administration.oauth.jks.claim.issuer.url")));
...
//        ImplicitResourceDetails resource = new ImplicitResourceDetails();
	...
	CorsConfigurationSource corsConfigurationSource() {
		...
		boolean abilitaCors = Boolean.parseBoolean(env.getProperty("administration.web.cors.enbaled"));
		if( abilitaCors )
		{
