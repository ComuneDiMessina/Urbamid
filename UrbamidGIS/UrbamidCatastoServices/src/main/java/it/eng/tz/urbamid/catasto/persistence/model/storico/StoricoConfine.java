...
@Entity
@Table(name="u_cat_confine_storico", schema="storico")
public class StoricoConfine implements Serializable {

	private static final long serialVersionUID = -1083183566418393270L;
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof StoricoConfine)) {
			return false;
		}
		StoricoConfine other = (StoricoConfine) obj;
