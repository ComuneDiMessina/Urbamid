...
@Entity
@Table(name="u_cat_confine")
//@AttributeOverrides({ @AttributeOverride(name = "id", column = @Column(name = "gid")) })
public class FoglioGeom implements Serializable {

	private static final long serialVersionUID = 4355925668365494209L;

	@Id 
	@SequenceGenerator(name="u_cat_confine_gid_seq", sequenceName="u_cat_confine_gid_seq", allocationSize=1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator="u_cat_confine_gid_seq")
