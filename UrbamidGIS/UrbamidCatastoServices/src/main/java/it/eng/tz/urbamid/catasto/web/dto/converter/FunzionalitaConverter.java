...
import it.eng.tz.urbamid.catasto.web.dto.FunzionalitaDto;
...
public class FunzionalitaConverter implements IConverter<Funzionalita, FunzionalitaDto>{
	...
	@Override
	public FunzionalitaDto toDto(Funzionalita model) throws ConverterException {
	...
	@Override
	public Funzionalita toModel(FunzionalitaDto dto) throws ConverterException {
	...
	@Override
	public List<FunzionalitaDto> toDto(List<Funzionalita> models) throws ConverterException {
