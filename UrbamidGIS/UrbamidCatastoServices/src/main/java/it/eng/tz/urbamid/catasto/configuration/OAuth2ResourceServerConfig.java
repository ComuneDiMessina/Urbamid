...
public class OAuth2ResourceServerConfig extends ResourceServerConfigurerAdapter {
	...
	public void configure(final ResourceServerSecurityConfigurer config) {
		...
		.resourceId(env.getProperty("catasto.oauth.resource.id"));
	}
	...
	{
		return new JwkTokenStore(env.getProperty("catasto.oauth.jwt.key.url"), accessTokenConverter());
	}
	...
	public JwtClaimsSetVerifier issuerClaimVerifier() {
		try {
			return new IssuerClaimVerifier(new URL(env.getProperty("catasto.oauth.jks.claim.issuer.url")));
