...
//		int timeout = new Integer(env.getProperty("rubrica.http.client.timeout"));
		int timeout = Integer.parseInt(env.getProperty("prg.http.client.timeout"));
		
		CloseableHttpClient httpClient = null;
		String keystores = env.getProperty("prg.certificate");
		...
		boolean proxyEnable = Boolean.valueOf(env.getProperty("prg.http.client.proxyEnable"));
		if (proxyEnable)
		{
			Integer proxyPort = Integer.valueOf(env.getProperty("prg.http.client.portProxy"));
			String proxyHost = env.getProperty("prg.http.client.hostProxy");
			BasicCredentialsProvider credentialProvider = new BasicCredentialsProvider();
			AuthScope scope = new AuthScope(proxyHost, proxyPort.intValue());
			String usernameProxy = env.getProperty("prg.http.client.usernameProxy");
			String passwordProxy = env.getProperty("prg.http.client.passwordProxy");
			...
			ProxyRoutePlanner proxyRoutPlanner = new ProxyRoutePlanner(new HttpHost(proxyHost, proxyPort.intValue()), env.getProperty("prg.http.client.urlNotProxy"));
