...
import it.eng.tz.urbamid.prg.exception.PRGDbException;
import it.eng.tz.urbamid.prg.service.PRGService;
import it.eng.tz.urbamid.prg.util.IConstants;
import it.eng.tz.urbamid.prg.web.response.BaseResponse;

public abstract class AbstractController {

	@Autowired
	PRGService baseService;
	...
	protected <T> ResponseEntity<BaseResponse<T>> okResponse(T payload) {
		...
		if (payload != null) {
			...
			koResponseError(new PRGDbException());
