	...
	<div class="generalContainer">
		...
		<div class="container-fluid nop">
			<div class="row nom nopt mainCont">
				<div class="container-fluid" style="padding: 3% 0px 2% 0px;/* margin: 0 30%; *//* width: 100%; */">
					<h2 class="text-align:center" style="margin: 0px 45%;width: 100%;color: red;font-size: 35px;">Accesso Negato</h2>
				</div>
			</div>
		</div>
	</div>
