...
<head>
	...
	<jsp:include page="/page/head.jsp"></jsp:include>
		...
		<script type="text/javascript" src="<%=request.getContextPath()%>/js/gestProfile/gestione-profile.js"></script>					<!-- Js per il caricamento della mappa -->
...
<body lang="it">
	...
	<div class="generalContainer">
		...
		<!-- USER-MAP -->
		<jsp:include page="/template/header/header-gestProfile.jsp"></jsp:include>
	    
	    <!-- ELENCO UTENTI -->
		<div id="containerPageUtenti" style="background-color:#fff">
			<jsp:include page="/template/profile/elencoUtenti.jsp"></jsp:include>
		</div>
	
		<!-- ELENCO RUOLI PERMESSI -->
		<div id="containerPageRuoliPermessi" style="background-color:#fff;display:none;">
			<jsp:include page="/template/profile/elencoRuoliPermessi.jsp"></jsp:include>
		</div>
	</div>
	...
	<jsp:include page="/template/profile/dettProfile-handlebars.jsp"></jsp:include>
</body>
</html>