...
<head>
	...
	<title>Servizi Gis Urbamid - Comune di Messina</title>
...
<body lang="it">
	...
	<div id="print" class="hidden">
		<div id="mapHeaderPrint">
			<h3>Urbamid+ Comune di Messina</h3>
		</div>
		<div id="mapPrintTool"><button onclick="window.print();appUtil.showLoader(null, 'Per favore, attendere il completamento dell\'operazione.');">Stampa</button></div>
		<div id="mapLeftPrint"></div>
		<div id="mapRightPrint">
			<h2>Tavole applicate alla mappa</h2>
			<div id="listaLayer">
			</div>
		</div>
