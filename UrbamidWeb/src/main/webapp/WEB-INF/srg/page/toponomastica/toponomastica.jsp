...
<head>
	...
	<link type="text/css" href="<%=request.getContextPath()%>/css/toponomastica.css" rel="Stylesheet">	
...
<body lang="it">
	...
	<jsp:include page="/template/toponomastica/toponomastica-handlebars.jsp"></jsp:include>
	<!-- CUSTOM PAGE CONTROLLER -->
	<script type="text/javascript" src="<%=request.getContextPath()%>/js/include/BaseModaleCtrl.js"></script>
	<script type="text/javascript" src="<%=request.getContextPath()%>/js/toponomastica/ToponomasticaCtrl.js"></script>

	<script type="text/javascript" src="<%=request.getContextPath()%>/js/toponomastica/AccessoCtrl.js"></script>
	<script type="text/javascript" src="<%=request.getContextPath()%>/js/toponomastica/AreaStradaleCtrl.js"></script>
	<script type="text/javascript" src="<%=request.getContextPath()%>/js/toponomastica/CippoChilometricoCtrl.js"></script>
	<script type="text/javascript" src="<%=request.getContextPath()%>/js/toponomastica/EstesaAmministrativaCtrl.js"></script>
	<script type="text/javascript" src="<%=request.getContextPath()%>/js/toponomastica/GiunzioneStradaleCtrl.js"></script>
	<script type="text/javascript" src="<%=request.getContextPath()%>/js/toponomastica/LocalitaCtrl.js"></script>
	<script type="text/javascript" src="<%=request.getContextPath()%>/js/toponomastica/PercorsiCtrl.js"></script>
	<script type="text/javascript" src="<%=request.getContextPath()%>/js/toponomastica/ToponimoStradaleCtrl.js"></script>
	<script type="text/javascript" src="<%=request.getContextPath()%>/js/toponomastica/ImportShapeFileCtrl.js"></script>

	
	<script type="text/javascript" src="<%=request.getContextPath()%>/js/toponomastica/ToponomasticaRest.js"></script>
