...
jQAjaxSupport.prototype = {
    ...
    _new: function () {
        ...
        this.messageDef = {success:"Operation performed successfully",error:"Failed operation"};
    ...
    setMessage: function (key, value, show_,isDef_) {
        this.message[key] = value;
        this.show[key] = typeof show_ === "boolean" ? show_ : true;
        if(typeof isDef_ !== "undefined" && typeof isDef_ === "boolean" && isDef_)
        this.messageDef[key] = value;	
        return this;
    },
    setMessageDefault: function (key, value) {
        this.messageDef[key] = value;
        return this;
    },
    ...
    setAction: function (value) {
     ...
     restoreMsg: function () {
    	 ...
    	 if(typeof this.messageDef[m]!=="undefined")
          this.message[m] = this.messageDef[m];
         return this;
     }, 
    /*
     * Type: String
    ...
    initSuccess:function(data){
        ...
        return ts__.restoreMsg();  
        },
    resolveUrl:function(url,act){
    var urlResolve=url+"/"+act,
    urlResolve=urlResolve.replace(/[(\/\/)]+[(\/)]/g, '/').replace(":/","://"),
    url__=urlResolve.indexOf('?')>0?urlResolve+'&__='+new Date().getTime():urlResolve+'?__='+new Date().getTime();
    return url__;
    },    
    setting: function () {
        var this__ = this;
